...
app.layout = dbc.Container([
    ...
    # ]),
        ...
        dbc.Row([
        dbc.Col(dcc.Graph(id='demographic_plot_1'), width=5),
...
@app.callback(
    #  Output(component_id='table_1',               component_property='children'),
...
def update_output_div(varx, vary, group, cat_var, cont_var):
    x  = spf.compute_summary_stats(data=ed.summary_table, value_var=varx, group_var=group, resetIndex=True)
    print(x)
    dt2 = html.Div([
            dash_table.DataTable(
                ...
                style_cell={
                    ...
                    # 'minWidth': '180px', 'width': '10px', 'maxWidth': '10px',
                    'overflow': 'hidden',
